...
const validateUpdateHotel = require('../../../validators/hotel/validateUpdateHotel')

const updateHotel = async (parent, args, ctx, info) => {
  authorize(ctx)
  await validateUpdateHotel(args.input, ctx)

  return await ctx.prisma.updateHotel({
    data: {
